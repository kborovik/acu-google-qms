...
* **2 ISO/IEC 17025 Accredited Third-Party Analytical Testing Laboratories** (`LAB-GL-ANALYTICAL` and `LAB-PACIFIC-TEST`).
...
├───────────────────────────────┬───────────────────────────────────┬────────────────────────────────────┤
│ QUALIFIED VENDOR              │ RAW MATERIAL PRODUCTS             │ CERTIFIED TESTING LAB              │
├───────────────────────────────┼───────────────────────────────────┼────────────────────────────────────┤
│ 1. Northern BioNutra Imports  │ • RAW-ECH-EXT4 (Echinacea 4%)     │ Great Lakes Bio-Analytical         │
│    (VEND-NORTH-BIO / Canada)  │ • RAW-ELD-EXT10 (Elderberry 10%)  │ (LAB-GL-ANALYTICAL - CALA #9481)   │
│                               │                                   │ Specialist: Chemical, HPLC & ICP-MS│
│ 2. Alpine Botanical Extracts  │ • RAW-ASH-EXT5 (Ashwagandha 5%)   ├────────────────────────────────────┤
│    (VEND-ALPINE-EXT / Germany)│ • RAW-RHOD-EXT3 (Rhodiola 3%)     │ Pacific Rim BioNutra Labs          │
│                               │                                   │ (LAB-PACIFIC-TEST - SCC #8172)     │
│ 3. Pacific Organic Ingredients│ • RAW-CURC-95 (Curcumin 95%)      │ Specialist: Micro, Solvents, Safety│
│    (VEND-PACIFIC-ORG / USA)   │ • RAW-GUT-PRB100 (Probiotics 100B)│                                    │
│                               │                                   │                                    │
│ 4. Nippon Pure Bioactives     │ • RAW-COQ10-99 (CoQ10 99% Pure)   │ Multi-Lab Dual Verification        │
│    (VEND-NIPPON-PHARMA / JP)  │ • RAW-THEA-98 (L-Theanine 98%)    │ Supported across all items         │
│                               │                                   │                                    │
│ 5. Nordic Marine Extracts     │ • RAW-OMEGA3-70 (Omega-3 Oil 70%) │                                    │
│    (VEND-NORDIC-MAR / Norway) │ • RAW-ASTA-10 (Astaxanthin 10%)   │                                    │
├───────────────────────────────┴───────────────────────────────────┴────────────────────────────────────┤
...
│   ├── test_labs.json                         <- 2 Laboratory profiles, accreditations & assay capabilities
...
```
[Inbound Raw Materials from 5 Vendors]
               │
               ▼
[AI CoA Inspection Engine vs QMS Plans]
               │
               ▼
